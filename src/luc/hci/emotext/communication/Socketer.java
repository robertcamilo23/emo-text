package luc.hci.emotext.communication;
...
{
	// Here put IP_Address
	private static final String AUTHENTICATION_SERVER_ADDRESS = "http://10.24.155.33/AndroidChatterDatabase/";
	...
	public String sendHttpRequest( String params )
	{
		...
		{
			Log.e( "sendHttpRequest ", "MalformedURLException" );
			e.printStackTrace( );
		}
		catch ( IOException e )
		{
			Log.e( "sendHttpRequest ", "IOException" );
			e.printStackTrace( );
		}
	...
	public int startListening( int portNo )
	{
		...
		{
			Log.e( "startListening.serverSocket ", "IOException" );
		...
		while ( listening )
		{
			...
			{
				Log.e( "startListening.receiveConnection ", "IOException" );
				return 2;
			}
		}
